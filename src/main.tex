...
\input{1 Intro.tex}
\input{2 Evaluation.tex}
\input{3 Efficient Algo.tex}
\input{4 Natural Language.tex}
\input{5 Indexing.tex}
\input{6 Compression.tex}
\input{7 Learning to Rank.tex}
\input{8 Language Models.tex}
\input{9 Efficient knn.tex}
